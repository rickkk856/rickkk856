...
def generate_profile_html(ai_quote):
    ...
    html_parts.append('  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&duration=3000&pause=1000&color=00BFFF&center=true&vCenter=true&multiline=false&repeat=true&width=600&lines=AI+Engineer+%7C+Data+Scientist;MSc+Architectural+Design+%2B+AI;5%2B+Years+Training+AI+Models" alt="Typing SVG" />')
    html_parts.append('</p>')
    html_parts.append('')
    ...
    html_parts.append(f'      <img src="https://img.shields.io/badge/🌍_Location-{location_encoded}-2196F3?style=for-the-badge&labelColor=0D1117" alt="Location"/>')
    html_parts.append('    </td>')
    html_parts.append(f'    <td align="center" style="padding: 0;">')
    html_parts.append(f'      <img src="https://img.shields.io/badge/📅_Today-{current_day}-00BFFF?style=for-the-badge&labelColor=0D1117" alt="Day"/>')
    html_parts.append('    </td>')
    html_parts.append('  </tr>')
    html_parts.append('</table>')
    html_parts.append('')
    html_parts.append('<!-- AI Insight Section -->')
